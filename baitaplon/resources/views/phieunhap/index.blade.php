			...
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						...
						<div class="col-sm-6">
							<a href=" {{route('phieunhap.create')}}" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Lập phiếu nhập sản phẩm</span></a>
				...
				<table border="1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $phieuNhap->MaNV_FK }}</td>
                            <td>{{ $phieuNhap->MaNCC_FK }}</td>
                            <td>{{ $phieuNhap->created_at }}</td>
                            <td>{{ $phieuNhap->updated_at }}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
