                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">		
                            <li><a href="{{route('hoadon.create')}}">Tạo hoá đơn</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">		
                            ...
                            <li><a href="{{ route('phieunhap.index') }}">Danh sách phiếu nhập sản phẩm</a></li>
                            <li><a href="{{ route('phieunhap.create') }}">Lập phiếu nhập sản phẩm</a></li>     
                        </ul>
                    </li>
                    <li class="dropdown">
