            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="./loginn.php">Đăng nhập</a></li>
                    </ul>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('checklogin') }}" method="POST">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="email" name="email" required autofocus autocomplete="username">
                        </div>
                ...
                <div class="card-footer">
                    <div class="d-flex justify-content-center ">
                        Don't have an account?<a href="{{ route('Dangki')}}" class="text-warning text-decoration-none">Sign Up</a>
                    </div>
                    <div class="d-flex justify-content-center">
